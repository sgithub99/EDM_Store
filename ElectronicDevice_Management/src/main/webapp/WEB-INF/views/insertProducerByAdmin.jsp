			...
			<main>
				<div class="container-fluid px-5">
					<a href="initProducerByAdmin?pageIndex=${pageIndex}"
						...
						Quay lại</a>
					<h1 class="mt-4">Thêm mới nhà cung cấp</h1>
					<form:form modelAttribute="producer"
						action="insertProducerByAdmin?pageIndex=${pageIndex }"
						method="post">
						<table class="table table-bordered" style="width: 1000px">

							<tr>
								<td>Mã nhà cung cấp</td>
								<td><form:input path="producerId" type="text" /></td>
							</tr>
							<tr>
								<td>Tên nhà cung cấp</td>
								<td><form:input path="producerName" type="text"
										required="required" /></td>
							</tr>
							<tr>
								<td scope="col">Địa chỉ nhà cung cấp</td>
								<td><form:textarea path="address" required="required" /></td>
							</tr>
						</table>
						<div>
							<button class="btn btn-success">
								<i class="fas fa-check-square"></i> Thêm mới
							</button>
						</div>
					</form:form>
				</div>
