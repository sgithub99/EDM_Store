...
<head>
<meta charset="UTF-8">
<title>QTV - Chi tiết nhà cung cấp</title>
<link
		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid px-5">
					<a href="initProducerByAdmin?pageIndex=${pageIndex}"
						class="btn btn-secondary mt-3"><i class="fas fa-backward"></i>
						Quay lại</a>
					<h1 class="mt-4">Thông tin nhà cung cấp</h1>
					<table class="table table-bordered" style="width: 1000px">
						<tr>
							<td scope="col">Mã nhà cung cấp</td>
							<td colspan="2">${producer.producerId }</td>
						</tr>
						<tr>
							<td scope="col">Tên nhà cung cấp</td>
							<td colspan="2">${producer.producerName }</td>
						</tr>
						<tr>
					...
					<div>
						<a class="btn btn-warning"
							href="initUpdateProducer?producerId=${producer.producerId }&pageIndex=${pageIndex}"><i
							class="far fa-edit"></i> Chỉnh sửa nhà cung cấp</a> <a
							class="btn btn-danger" href="deleteProducerByAdmin?producerId=${producer.producerId}&pageIndex=${pageIndex}"
							onclick="return confirm('Bạn có chắc muốn xoá nhà cung cấp?')"><i class="fas fa-trash-alt"></i>
							Xoá nhà cung cấp</a>
					</div>
				</div>
			</main>
