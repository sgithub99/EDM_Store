		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid px-5">
					...
					<form:form modelAttribute="product" action="insertProductByAdmin?pageIndex=${pageIndex }"
						...
						<table class="table table-bordered" style="width: 1000px">
							...
							<tr>
								<td>Tên sản phẩm</td>
								<td><form:input path="proName" type="text" /></td>
							</tr>
							<tr>
								<td scope="col">Giá</td>
							...
							<tr>
								<td scope="col">Ảnh</td>
								<td><input name="imageProduct" type="file" /></td>
							</tr>
							<tr>
								<td>Mô tả</td>
