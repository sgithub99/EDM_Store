		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid px-5">
					<a
						href="detailProducerByAdmin?producerId=${producer.producerId}&pageIndex=${pageIndex}"
					...
					<form:form modelAttribute="producer"
						action="updateProducerByAdmin?pageIndex=${pageIndex }"
						method="post">
						<table class="table table-bordered" style="width: 1000px">
							<tr>
								<td>Mã nhà cung cấp</td>
								<td><form:input path="producerId" type="text"
										readonly="true" /></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><form:textarea path="address" type="text"
										required="required" /></td>
							</tr>
						</table>
						<div>
