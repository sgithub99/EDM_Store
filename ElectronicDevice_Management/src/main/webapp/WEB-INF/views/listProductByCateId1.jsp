...
<body>
	...
	<!-- Breadcrumb Start -->
	<div class="container" style="margin-top: 168px; z-index: 1;">
		<h1>Danh mục sản phẩm: ${category.cateName}</h1>
	</div>
	<!-- Breadcrumb End -->
		...
		<div class="container">
			<div class="col-lg-12">
				<div class="row">
							...
							<div class="row">
								...
								<div class="col-md-3">
									<!-- 	<div class="product-short">
										<div class="dropdown">
											<div class="dropdown-toggle" data-toggle="dropdown">Nhà
												sản xuất</div>
											<div class="dropdown-menu dropdown-menu-right">
												<a href="sortByLowerPrice" class="dropdown-item">Giá cao
													xuống thấp</a> <a href="sortByHigherPrice"
										...
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												<a href="#" class="dropdown-item">$0 to $50</a> <a href="#"
													...
													class="dropdown-item">$151 to $200</a>
											</div>
										</div>
									</div>
								</div> -->
					...
					<c:forEach items="${listProductByCateId }" var="product">
						<div class="col-md-4">
						...
						<ul class="pagination justify-content-center">
							<c:forEach items="${listPages }" var="page">
								<li class="page-item "><a class="page-link"
									href="listProductByCateId?pageIndex=${page}&cateId=${cateId}">${page}</a></li>
							</c:forEach>
						</ul>
					</nav>
				</div>
