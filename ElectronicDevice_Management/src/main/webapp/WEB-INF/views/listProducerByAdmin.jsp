...
<head>
<meta charset="UTF-8">
<title>Trang quản lý nhà cung cấp</title>
<link
				...
				<%-- 	<div class="dropdown show col-3" style="padding-left: 18%">
						...
						<div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
							<a class="dropdown-item"
								href="sortByNameProducerASC?pageIndex=${pageIndex}">Tên từ A
								- Z</a> <a class="dropdown-item"
								href="sortByNameProducerDESC?pageIndex=${pageIndex}">Tên từ
								Z - A</a>
						</div>
					</div> --%>
					<div class="col-6" style="padding-left: 9%">
						<a href="initInsertProducerByAdmin?pageIndex=${pageIndex }"
						...
						<c:forEach items="${listProducers }" var="producer">
							<tr>
								...
								<td><a class="btn btn-info"
									href="detailProducerByAdmin?producerId=${producer.producerId }&pageIndex=${pageIndex}">Xem</a></td>
							</tr>
							...
							<c:choose>
								<c:when test="${x eq 1}">
									<li class="page-item "><a class="page-link"
										href="initProducerByAdmin?pageIndex=${page}&x=${x}">${page}</a></li>
								</c:when>
								<c:when test="${x eq 2}">
									<li class="page-item "><a class="page-link"
