	...
	<div class="center">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						<li class="nav-item"><a class="nav-link active"
							aria-current="page" href="loadProducts">Trang chủ</a></li>
					...
					<form class="d-flex">
						<button class="btn btn-outline-dark" type="submit">
							...
							<i class="bi-cart-fill me-1"></i> Price <span
								class="badge bg-dark text-white ms-1 rounded-pill"><fmt:formatNumber
									type="number" value="${TotalPrice}" /></span>
						</button>
					</form>
				</div>
			</div>
		...
		<table border="1">
			...
			<c:forEach items="${listProductByCateId }" var="product">
				<tr>
					...
					<td><a href="detailProduct?proId=${product.proId }">Detail</a></td>
		...
		<div class="center-pagination">
			<c:forEach items="${listPages }" var="page">
				<a href="listProductByCateId?pageIndex=${page}&cateId=${cateId}">${page}</a>&nbsp;&nbsp;&nbsp;
			</c:forEach>
		</div>
	</div>
	<script
